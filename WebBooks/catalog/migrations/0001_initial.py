    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Введите краткое описание книги', max_length=1000, verbose_name='Краткое описание книги')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(help_text='Введите статус экземпляра', on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Статус экземпляра')),
            ],
        ),
        migrations.AddField(
            model_name='book',
