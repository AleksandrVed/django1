...
# SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'cg#p$g+j9tax!#a3cup@1$8obt2_+&q+pmu)5%asj6yjpkag')
SECRET_KEY = 'django-insecure-+d**@*s_b=ch$i!*+k1i#$u!=lrua+7b6geh*#^_w%=(*&pl0$'
